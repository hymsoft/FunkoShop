...
const newTitle = `FunkoShop - ${tools.capitalizeFirstLetters(currentCollection.name)} Collection`;
...
const collectionsCardsHTML =
  `<h1 id="collection-name" class="text--upper">${currentCollection.name}</h1>
