  ...
  <article class="item" data-id="${currentFunko.id}">
    <div class="item__container">
      <figure class="item__image">
        ${currentFunko.new ? '<div class="item__new-message item__new">nuevo</div>' : ''}
        <img src="/front/img/shop/${currentFunko.imgPath}/${currentFunko.img1}" alt="${tools.capitalizeFirstLetters(currentFunko.name)} Image" />
      </figure>
